...
X_train, y_train = dp.get_processed_data('Training-a1-a2.csv','/home/ubuntu/project4/lab-cs-ml-00301/ScenarioC/Total/','binary')
X_test, y_test = dp.get_processed_data('Testing-a1-a2-a3.csv','/home/ubuntu/project4/lab-cs-ml-00301/ScenarioC/Total/','binary')
...
#from sklearn.preprocessing import StandardScaler
#sc = StandardScaler()
#X_total = np.vstack((X_train,X_test)).T
#rightFit = sc.fit(X_total)

#X_train = rightFit.transform(X_train)
#X_test = rightFit.transform(X_test)
